		...
		<div class="row">
			<div class="col-md-9 col-sm-12 col-xs-12">
				<div class="row">
					<div class="col-md-4 col-sm-12 col-xs-12">
						<div class="blog-item-style-2">
							<a href="blogdetail.php"><img src="images/uploads/blogv21.jpg" alt=""></a>
							<div class="blog-it-infor">
								<h3><a href="blogdetail.php">Godzilla: King Of The Monsters Adds O’Shea Jackson Jr</a></h3>
					...
					<div class="col-md-4 col-sm-12 col-xs-12">
						<div class="blog-item-style-2">
							<a href="blogdetail.php"><img src="images/uploads/blogv22.jpg" alt=""></a>
							<div class="blog-it-infor">
								<h3><a href="blogdetail.php">First Official Images of Alicia Vikander As Tomb Raider’s Lara Croft</a></h3>
								<span class="time">27 Mar 2017</span>
					...
					<div class="col-md-4 col-sm-12 col-xs-12">
						<div class="blog-item-style-2">
							<a href="blogdetail.php"><img src="images/uploads/blogv23.jpg" alt=""></a>
							<div class="blog-it-infor">
								<h3><a href="blogdetail.php">The Boss Baby Holds On At The Top US Box Office</a></h3>
								<span class="time">27 Mar 2017</span>
				...
				<div class="row">
					<div class="col-md-4 col-sm-12 col-xs-12">
						<div class="blog-item-style-2">
							<a href="blogdetail.php"><img src="images/uploads/blogv24.jpg" alt=""></a>
							<div class="blog-it-infor">
								<h3><a href="blogdetail.php">Stephen King and Owen King's Novel Sleeping Beauties Being</a></h3>
								<span class="time">27 Mar 2017</span>
					...
					<div class="col-md-4 col-sm-12 col-xs-12">
						<div class="blog-item-style-2">
							<a href="blogdetail.php"><img src="images/uploads/blogv29.jpg" alt=""></a>
							<div class="blog-it-infor">
								<h3><a href="blogdetail.php">Pablo Larrain Directing Tom Hardy In The True American</a></h3>
								<span class="time">27 Mar 2017</span>
					...
					<div class="col-md-4 col-sm-12 col-xs-12">
						<div class="blog-item-style-2">
							<a href="blogdetail.php"><img src="images/uploads/blog29.jpg" alt=""></a>
							<div class="blog-it-infor">
								<h3><a href="blogdetail.php">Michael Keaton Looking To Play A Villain In Dumbo</a></h3>
								<span class="time">27 Mar 2017</span>
				...
				<div class="row">
					<div class="col-md-4 col-sm-12 col-xs-12">
						<div class="blog-item-style-2">
							<a href="blogdetail.php"><img src="images/uploads/blog27.jpg" alt=""></a>
							<div class="blog-it-infor">
								<h3><a href="blogdetail.php">Sam Mendes In Talks To Develop Graphic Novel </a></h3>
								<span class="time">27 Mar 2017</span>
					...
					<div class="col-md-4 col-sm-12 col-xs-12">
						<div class="blog-item-style-2">
							<a href="blogdetail.php"><img src="images/uploads/blog26.jpg" alt=""></a>
							<div class="blog-it-infor">
								<h3><a href="blogdetail.php">Eric Roth To Write Dune For Denis Villeneuve</a></h3>
								<span class="time">27 Mar 2017</span>
					...
					<div class="col-md-4 col-sm-12 col-xs-12">
						<div class="blog-item-style-2">
							<a href="blogdetail.php"><img src="images/uploads/blogv25.jpg" alt=""></a>
							<div class="blog-it-infor">
								<h3><a href="blogdetail.php">John Simm Returning To Doctor Who As The Master</a></h3>
								<span class="time">27 Mar 2017</span>
...
<?php include_once'./components/layer/footer.php'; ?>
    ...
    <div class="login-content">
        ...
        <form method="post" action="#">
            <div class="row">
                 <label for="name">
                    Name:
                    <input type="text" name="name" id="name" placeholder="" pattern="^[a-zA-Z][a-zA-Z0-9-_\.]{8,20}$" required="required" />
                </label>
            </div>
            ...
            <div class="row">
                <label for="username">
                   Username:
                    <input type="password" name="username" id="username" placeholder="" pattern="(?=^.{8,}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$" required="required" />
                </label>
            </div>
             <div class="row">

...
?>
    ...
    <div class="slider movie-items">
      <div class="container">
        <div class="row">
          <!-- start social media  -->
          <?php include_once'./components/common/social_media_card.php'; ?>
          <!-- end social media  -->
          <div class="slick-multiItemSlider">
            <!-- start movie card -->
            <?php include_once'./components/common/movie_card.php'; ?>
            <!-- end movie card -->
          </div>
        </div>
      </div>
                  ...
                  <div class="row">
                    <div class="blog-item-style-1">
                      ...
                      <div class="blog-it-infor">
                        ...
                        <p>
                          Exclusive: <span>Amazon Studios </span>has acquired Victoria Woodhull, with Oscar winning Room star <span>Brie Larson</span> polsed to produce, and play the first female candidate for the presidency of the United
                          States. Amazon bought it in a pitch package deal. <span> Ben Kopit</span>, who wrote the Warner Bros film <span>Libertine</span> that has...
                        </p>
                      </div>
                    </div>
                  </div>

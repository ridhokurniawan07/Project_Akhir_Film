                                ...
                                <div class="modal fade text-left" id="inlineForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="prosestambahaktor.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="proseshapusaktor.php?actor_id=<?= $data['actor_id'] ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus aktor ini?')">
                        ...
                        <div class="modal fade text-left" id="editForm<?= $data['actor_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="proseseditaktor.php" method="POST" enctype="multipart/form-data">
                                        <div class="modal-body">

		...
		<div class="row ipad-width2">
			<div class="col-md-9 col-sm-12 col-xs-12">
				<div class="topbar-filter">
					...
					<a  href="celebritygrid01.php" class="grid"><i class="ion-grid "></i></a>
				</div>
				<div class="row">
					<div class="col-md-12">
						<div class="ceb-item-style-2">
							...
							<div class="ceb-infor">
								<h2><a href="celebritysingle.php">Dan Stevens</a></h2>
								<span>actor, usa</span>
					...
					<div class="col-md-12">
						<div class="ceb-item-style-2">
							...
							<div class="ceb-infor">
								<h2><a href="celebritysingle.php">Luke Evans</a></h2>
					...
					<div class="col-md-12">
						<div class="ceb-item-style-2">
							...
							<div class="ceb-infor">
								<h2><a href="celebritysingle.php">Scarlett Johansson</a></h2>
					...
					<div class="col-md-12">
						<div class="ceb-item-style-2">
							...
							<div class="ceb-infor">
								<h2><a href="celebritysingle.php">Emma Watson</a></h2>
					...
					<div class="col-md-12">
						<div class="ceb-item-style-2">
							...
							<div class="ceb-infor">
								<h2><a href="celebritysingle.php">Tom Hardy</a></h2>
					...
					<div class="col-md-12">
						<div class="ceb-item-style-2">
							...
							<div class="ceb-infor">
								<h2><a href="celebritysingle.php">Joan Crawford</a></h2>
					...
					<div class="col-md-12">
						<div class="ceb-item-style-2">
							...
							<div class="ceb-infor">
								<h2><a href="celebritysingle.php">Margot Robbie</a></h2>
					...
					<div class="col-md-12">
						<div class="ceb-item-style-2">
							...
							<div class="ceb-infor">
								<h2><a href="celebritysingle.php">Jason Momoa</a></h2>
								<span>actor, usa</span>

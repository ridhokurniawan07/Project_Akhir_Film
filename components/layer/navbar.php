<nav class="navbar navbar-default navbar-custom">
    ...
    <ul class="nav navbar-nav flex-child-menu menu-left">
        ...
        <ul class="dropdown-menu level1">
            <li><a href="genre.php">Comedy</a></li>
            <li><a href="genre.php">Fantasy</a></li>
            <li><a href="genre.php">Hoory</a></li>
            <li><a href="genre.php">Sci-fi</a></li>
            <li><a href="genre.php">Drama</a></li>
            <li class="it-last"><a href="genre.php">Romance</a></li>
        </ul>
        </li>
        <!-- <li class="dropdown first">
            <a class="btn btn-default dropdown-toggle lv1" data-toggle="dropdown" data-hover="dropdown"> community <i class="fa fa-angle-down" aria-hidden="true"></i> </a>
            <ul class="dropdown-menu level1">
